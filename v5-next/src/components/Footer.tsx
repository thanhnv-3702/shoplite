      ...
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-10 md:grid-cols-3 md:px-6">
        ...
        <nav aria-labelledby="footer-nav-title">
          ...
          <ul className="mt-2 list-none space-y-1 p-0 text-sm text-ink-soft">
            <li>
              <Link className="no-underline hover:text-ink" href="/">
                Trang chủ
              </Link>
            </li>
            <li>
              <Link className="no-underline hover:text-ink" href="/cart">
                Giỏ hàng
              </Link>
            </li>
            <li>
              <Link className="no-underline hover:text-ink" href="/orders">
                Đơn hàng
              </Link>
            </li>
            <li>
              <Link className="no-underline hover:text-ink" href="/login">
                Đăng nhập
              </Link>
            </li>
          </ul>
